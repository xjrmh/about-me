...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'profile.summaryTitle': 'SUMMARY',
    'profile.summary': 'Data Scientist TL with 9+ years of experience shipping data-driven products from 0->1 and scaling to global audiences. Expertise in experimentation, causal inference, LLM/AI eval/integration, Search, measurement, and product growth.',
    ...
    'exp.meta.desc': 'Led IG Search × MetaAI integration by enabling LLM-based query understanding and personalized ranking; drove the global launch of E2EE on Messenger by leading experiment design, GTM strategies, & capacity plannin .',
    'exp.meta.bullet1': '0→1: Set launch criteria and drove AI Search integration into Instagram.',
    'exp.meta.bullet2': '1→100: Rebuilt the search stack end-to-end, driving 21% YoY growth in high-quality search volume.',
    'exp.meta.bullet3': 'Built LLM eval and benchmark frameworks for quality, safety, and regressions, including human-in-the-loop annotation and prompt optimization.',
    'exp.meta.bullet4': 'Designed a predictive demand and capacity framework that informed company investment decisions and unblocked IG AI Search launch.',
    'exp.meta.bullet5': 'Led a cross-functional analytics team improving IG Search quality and enabling MetaAI features like summarization and content recognition.',
    'exp.meta.bullet6': 'Drove launch go/no-go decisions through experiment design, metric definition, rollout planning, and causal analysis.',
    'exp.meta.bullet7': 'Built custom A/B frameworks for cluster and network experiments that later became an org standard.',
    'exp.meta.bullet8': 'Set roadmap priorities from user friction, opportunity sizing, and experimentation/holdout signals, and supported DS and engineering hiring.',
    ...
    'exp.cofounder.desc': 'Providing homebuyers with a simple, transparent, and low-cost experience, while empowering realtors with AI agents that automate lead conversion and ensure effortless transaction compliance.',
  ...
  zh: {
    ...
    'profile.summaryTitle': '个人简介',
    'profile.summary': '拥有9年以上经验的数据科学技术负责人，擅长推动数据驱动产品从0→1并规模化到全球用户。专长于实验设计、因果推断、LLM/AI评估与集成、搜索相关性、指标体系与战略规划。',
    ...
    'exp.meta.bullet1': '0→1：设定上线标准并推动 AI Search 在 Instagram 上落地。',
    'exp.meta.bullet2': '1→100：端到端重构搜索系统，推动高质量搜索量同比增长 21%。',
    'exp.meta.bullet3': '搭建 LLM 质量、安全与回归评估框架和基准体系，覆盖人机协同标注与提示词优化。',
    'exp.meta.bullet4': '设计需求与容量预测框架，支持公司级投资决策，并推动 IG AI Search 上线。',
    'exp.meta.bullet5': '领导跨职能分析团队提升 IG Search 质量，并支持 MetaAI 的摘要和内容识别等能力。',
    'exp.meta.bullet6': '通过实验设计、指标定义、上线规划和因果分析推动产品 go/no-go 决策。',
    'exp.meta.bullet7': '构建用于集群和网络实验的定制化 A/B 框架，后成为组织标准。',
    'exp.meta.bullet8': '基于用户摩擦、机会评估和实验/留存对照信号制定路线图，并支持数据科学和工程招聘。',
