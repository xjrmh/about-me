...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'profile.summary': 'Data science tech lead with 9+ years of experience shipping data-driven products from 0→1 and scaling them to global audiences. Expertise in experimentation, causal inference, LLM/AI evaluation and integration, search relevance, measurement, and strategic planning.',
    ...
    'exp.meta.bullet3': 'Designed eval frameworks and benchmark suites for LLM quality, safety, and regression; built human-in-the-loop annotation pipelines and A/B test framework for system-level prompts',
    'exp.meta.bullet4': 'Led a cross-functional analytics team improving IG search quality while enabling MetaAI features such as AI summarization and content recognition',
    'exp.meta.bullet5': 'Drove product go/no-go launch decisions by designing experiments, defining goals/metrics, designing rollout plans, & iterating with causal studies',
    'exp.meta.bullet6': 'Designed customized A/B test frameworks for cluster/network experiments, later became standard practice across Org',
    'exp.meta.bullet7': 'Set team roadmaps by identifying user frictions, sizing/prioritizing opportunities, and estimating timeline; supported DS and engineering hiring',
  ...
  zh: {
    ...
    'exp.meta.bullet3': '设计评估框架与基准测试套件，用于衡量LLM质量、安全与回归；构建人机协同标注流程及用于系统级提示词评估的A/B测试框架',
    'exp.meta.bullet4': '领导跨职能分析团队提升IG搜索质量，同时支持MetaAI功能（如AI摘要和内容识别）',
    'exp.meta.bullet5': '通过设计实验、定义目标/指标、制定上线计划及因果分析推动产品发布决策',
    'exp.meta.bullet6': '设计定制化A/B测试框架用于集群/网络实验，后成为全组织标准实践',
    'exp.meta.bullet7': '通过识别用户痛点、量化机会优先级和估算时间线制定团队路线图；支持数据科学和工程团队招聘',
