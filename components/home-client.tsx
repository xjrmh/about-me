  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen overflow-hidden overflow-x-hidden bg-background relative fixed inset-0 lg:static w-full max-w-full">
      ...
      <div className="lg:hidden flex flex-col h-full w-full">
        ...
        <header className="border-b border-border/40 px-4 pt-4 pb-3">
          ...
          {/* Social Links */}
          <nav className="flex items-center gap-3 mt-2.5 pl-[60px]" aria-label="Social links">
      ...
      <section className="hidden lg:block w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-border/40 overflow-y-auto overflow-x-hidden lg:px-2" aria-label="Profile and Experience">
        <ProfileSection />
      </section>

      {/* Middle Panel - Projects Section */}
      <section className="hidden lg:block w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-border/40 overflow-y-auto overflow-x-hidden lg:px-2" aria-label="Projects">
        <ProjectsSection />
      </section>

      {/* Right Panel - Chat Section */}
      <section className="hidden lg:flex flex-1 overflow-hidden overflow-x-hidden w-full lg:w-1/3 lg:px-2" aria-label="AI Chat">
        <ChatSection
          onMessagesChange={setHasMessages}
          showProfile={showProfile}
          onToggleProfile={() => setShowProfile(!showProfile)}
